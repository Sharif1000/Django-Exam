...
class TransferMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user, amount, "Transfer Message", "transactions/transferSender_email.html")
        send_transaction_email(recipient_account.user, amount, "Transfer Message", "transactions/transferReceiver_email.html")
        return super().form_valid(form)
